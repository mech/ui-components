...
import { InfoIcon, MessageSquareDashed, Sparkles, Shapes } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <p className="rounded-lg bg-gray-50 p-4">
        ...
        architecto assumenda at atque dicta ea error excepturi, facere fugit id
        impedit in iste, minus molestias necessitatibus repellat suscipit, velit
        voluptatem.
      </p>
