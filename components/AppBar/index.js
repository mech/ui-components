...
const AppBar = () => {
  return (
    <div className="w-[250px] space-y-3 border-r px-2 text-gray-800 dark:text-gray-400">
      <div className="grid grid-cols-[16px_20px_1fr] items-center gap-2 rounded-full bg-amber-100 py-1 text-black dark:bg-amber-900 dark:text-amber-500">
        <HomeIcon className="col-start-2" />
        <span className="text-lg font-normal subpixel-antialiased">Home</span>
      </div>

      <div className="grid grid-cols-[16px_20px_1fr] items-center gap-2">
        <span></span>
        <NotificationIcon />
      ...
      <Accordion type="multiple" className="space-y-4">
        <AccordionItem outline={false} value="organizations">
          <AccordionTrigger
            arrow={false}
            className="grid grid-cols-[16px_20px_1fr] gap-2 text-justify [&[data-state=open]>.accordion-arrow]:rotate-90"
          >
      ...
      <div className="grid grid-cols-[16px_20px_1fr] items-center gap-2">
        ...
        <span className="text-lg font-normal subpixel-antialiased">Recent</span>
      </div>
...
const NotificationIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="22.385">
